...
check_root_fs
for FILE in 8723ds.ko boot0_sdcard_sun20iw1p1.bin boot.scr Image.gz Image licheerv_u-boot.toc1 ; do
...
${SUDO} dd if="${OUT_DIR}/licheerv_u-boot.toc1" of="${DEVICE}" bs=512 seek=32800
